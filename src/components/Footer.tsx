...
export default function Footer() {
  return (
    <footer className="py-16 bg-[#0a0f1c] text-center border-t border-white/5">
      <div className="container-custom flex flex-col items-center gap-8">
        ...
        <div className="flex items-center gap-4 mt-2">
          <a href="https://instagram.com/veta.systems" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-white transition-colors" aria-label="Instagram de Veta">
